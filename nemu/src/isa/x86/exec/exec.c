...
static OpcodeEntry opcode_table [512] = {
  ...
  /* 0x30 */	EMPTY, IDEX(G2E,xor), EMPTY, EMPTY, //todo5 --done
  ...
  /* 0x54 */	EMPTY, IDEX(r,push), EMPTY, EMPTY,    //todo1 --done?
  /* 0x58 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x5c */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x60 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x64 */	EMPTY, EMPTY, EX(operand_size), EMPTY,
  /* 0x68 */	IDEX(I,push), EMPTY, EMPTY, EMPTY,   //todo2 --done
  ...
  /* 0x88 */	EMPTY, IDEX(mov_G2E, mov), IDEXW(mov_E2G, mov, 1), IDEX(mov_E2G, mov),
  ...
  /* 0xe8 */	IDEX(J, call), EMPTY, EMPTY, EMPTY,  //todo3 --done
