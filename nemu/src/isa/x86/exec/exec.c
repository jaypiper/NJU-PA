...
static OpcodeEntry opcode_table [512] = {
  ...
  /* 0x30 */	IDEXW(G2E,xor,1), IDEX(G2E,xor), IDEXW(E2G,xor,1), IDEX(E2G,xor), //todo5 --done
  ...
  /* 0x54 */	IDEX(r,push), IDEX(r,push), IDEX(r,push), IDEX(r,push),    //todo1 --done?
  ...
  /* 0x80 */	IDEXW(I2E, gp1, 1), IDEX(I2E, gp1), EMPTY, IDEX(SI2E, gp1), //todo4
  ...
  /* 0xcc */	IDEXW(I,int,1), EMPTY, EMPTY, EMPTY,
  ...
  /* 0xe8 */	IDEX(J, call), IDEX(J,jmp), EMPTY, IDEXW(J, jmp, 1),  //todo3 --done
...
/*2 byte_opcode_table */
  ...
  /* 0xb8 */	IDEXW(mov_E2G,movzx,1), IDEXW(mov_E2G,movzx,2), EMPTY, EMPTY,
